...
public class NewMovie extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        //if (item.getItemId() == R.id.action_settings){
            ...
            if (conexion.CompruebaConexion()){
                ...
                Toast.makeText(getApplicationContext(), "No se ha establecido la conexión. Por favor, conecta tu...", Toast.LENGTH_LONG).show();
        //}
    ...
    public void guardarPeli() {
        // if (validarCampos()){​​
        pelicula= new Pelicula (tituloEdit.getText().toString(), sinopsisEdit.getText().toString(),
                listaCategorias.get(spinnerCategoria.getSelectedItemPosition()), fechaEdit.getText().toString(),
                duracionEdit.getText().toString(),"","","");
        // }​​
    ...
    public void compartirPeli() {
        ...
        itSend.putExtra(Intent.EXTRA_SUBJECT, R.string.subject_compartir + ":" + pelicula.getTitulo());
        itSend.putExtra(Intent.EXTRA_TEXT, R.string.titulo
                + ": " + pelicula.getTitulo() + "\n"
                + "Argumento"
