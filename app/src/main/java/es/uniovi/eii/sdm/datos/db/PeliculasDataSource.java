 ...
 * <p>
 * DAO para la tabla de películas.
 * Se encarga de abrir y cerrar la conexion, asi como hacer las consultas relacionadas con la tabla Peliculas
 */
public class PeliculasDataSource {
     ...
     */
    private final String[] allColumns = {MyDBHelper.COLUMNA_ID_PELICULAS,
            MyDBHelper.COLUMNA_TITULO_PELICULAS, MyDBHelper.COLUMNA_ARGUMENTO_PELICULAS,
            MyDBHelper.COLUMNA_CATEGORIA_PELICULAS, MyDBHelper.COLUMNA_DURACION_PELICULAS,
            MyDBHelper.COLUMNA_FECHA_PELICULAS, MyDBHelper.COLUMNA_CARATULA_PELICULAS,
            MyDBHelper.COLUMNA_FONDO_PELICULAS, MyDBHelper.COLUMNA_TRAILER_PELICULAS};
